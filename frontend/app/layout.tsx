...
export const metadata: Metadata = {
  ...
  description:
    'Ingest a CSV/Excel file and get KPI cards, a revenue time-series, category/region breakdowns, a filterable table and PDF/Excel/CSV export. A static demo by Mohamed Adel Mamoun.',
};
      ...
      <body>
        <header className="border-b border-slate-200 bg-white">
          <div className="mx-auto flex max-w-dash items-center justify-between px-4 py-3">
            <div className="flex items-center gap-2.5">
              ...
              <span className="rounded-full bg-amber-100 px-2 py-0.5 text-xs font-medium text-amber-700">Demo</span>
            </div>
            <a
        ...
        <footer className="mt-10 border-t border-slate-200 bg-white">
          <div className="mx-auto max-w-dash px-4 py-6 text-sm text-slate-500">
            InsightBoard is a portfolio demo with bundled sample data — by{' '}
